...
<div class="page-header">
    <div class="page-title">
        ...
        <p class="text-muted">تعديل معلومات الدور وصلاحياته</p>
    </div>
...
<div class="row">
    <div class="col-lg-8">
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('dashboard.roles.update', $role) }}" id="roleForm">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('description') is-invalid @enderror"
                                  ...
                                  placeholder="وصف مختصر للدور...">{{ old('description', $role->description) }}</textarea>
                        @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <input type="color" class="form-control form-control-color @error('color') is-invalid @enderror"
                                           id="color" name="color" value="{{ old('color', $role->color) }}">
                                    <input type="text" class="form-control" id="colorText" value="{{ old('color', $role->color) }}" readonly>
                                </div>
                                @error('color')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
