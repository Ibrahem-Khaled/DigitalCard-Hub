...
class DigitalCardsStoreSeeder extends Seeder
{
    /**
    ...
    public function run(): void
    {
        ...
        for ($i = 1; $i <= 50; $i++) {
            DigitalCard::create([
                ...
                'card_code' => 'PUBG' . str_pad($i, 6, '0', STR_PAD_LEFT),
        ...
        for ($i = 1; $i <= 75; $i++) {
            DigitalCard::create([
                ...
                'card_code' => 'FF' . str_pad($i, 6, '0', STR_PAD_LEFT),
                'card_pin' => str_pad(rand(1000, 9999), 4, '0', STR_PAD_LEFT),
                'value' => 100,
                'currency' => 'USD',
                'status' => 'active',
        ...
        foreach ($knowledgeBase as $kbData) {
            \App\Models\AIKnowledgeBase::create($kbData);
        }
